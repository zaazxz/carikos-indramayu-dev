                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="warna" value="<?php echo old('warna') ?>" class="form-control" id="warna">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" name="geojson" id="geojson" value="<?php echo old('geojson') ?>" class="form-control" style="height: 400px; width: 100%; resize: none"></textarea>
