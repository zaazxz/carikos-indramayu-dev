<div class="col-md-12">
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <!-- Form : Start -->
            <form action="/dashboard/users/update/<?php echo $user[0]['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" value="<?php echo $user[0]['name']; ?>" placeholder="Cth: John Doe" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input name="email" value="<?php echo $user[0]['email']; ?>" placeholder="Cth: hW9lC@example.com" class="form-control" type="email">
                        ...
                        <div class="form-group">
                            ...
                            <input name="phone" value="<?php echo $user[0]['phone']; ?>" placeholder="Cth: +628123456789" class="form-control" type="text">
